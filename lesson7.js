...
// функцию проверки взяла из решения, показанном на уроке

function jump(coord_y,coord_x) {
    var new_unit;
    if (direction == 'x-') {
...
function haveFood(unit) {
    ...
    if (unit_classes.includes('food-unit')) {
        ...
        createFood();
        score++;
        document.getElementById('online-score').innerHTML = "Онлайн счет: " + score;
    }
    return check;
}
